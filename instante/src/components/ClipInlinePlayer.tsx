...
import { Play, X, Clock, MapPin, Copy, Maximize2, ExternalLink, AlertTriangle } from 'lucide-react';
import type { ClipWithDetails } from '../lib/supabase/types';

interface ClipInlinePlayerProps {
  clip: ClipWithDetails;
  videoUrl: string;
  onClose: () => void;
}

export function ClipInlinePlayer({ clip, videoUrl, onClose }: ClipInlinePlayerProps) {
  ...
  const viewUrl = `https://drive.google.com/file/d/${fileId}/view?t=${Math.floor(clip.start_time)}s`;
  const embedUrl = `https://drive.google.com/file/d/${fileId}/preview?t=${Math.floor(clip.start_time)}s`;
        ...
        <div className="relative aspect-video w-full max-w-2xl mx-auto rounded-lg overflow-hidden bg-black">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center hidden">
            <div className="text-center">
              ...
              <p className="text-gray-600 font-medium">{clip.description}</p>
            </div>
          </div>
          ...
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
            <div className="text-center text-white">
              ...
              <p className="font-medium">{clip.description}</p>
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm">
              <p className="font-medium text-blue-900 dark:text-blue-100">
                🎬 Clip de Google Drive
              </p>
              <ul className="mt-1 text-blue-800 dark:text-blue-200 space-y-1">
                <li>• Este clip se reproduce desde Google Drive</li>
